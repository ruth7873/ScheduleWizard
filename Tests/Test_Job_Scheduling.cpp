...
//
//        //std::thread schedulerThread([&s, nonCriticalTask, criticalTask]() {
//        //    // Simulate execution of tasks
//        //    s.execute(nonCriticalTask); // Start executing the non-critical task
//        //    s.execute(criticalTask);       // Then, execute the critical task
//        //    });
...
//
//        CHECK(criticalTask->getStatus() == TaskStatus::RUNNING);

...
const string Scenario::SCENARIO_1_FILE_PATH = "C:/Users/מיכל/Documents/BootCamp/ScheduleWizard/Main/tests/scenario_1.json";
...
const string Scenario::SCENARIO_4_FILE_PATH = "tests/scenario_4.json";
const string Scenario::SCENARIO_5_FILE_PATH = "tests/scenario_5.json";
const string Scenario::SCENARIO_6_FILE_PATH = "tests/scenario_6.json";
